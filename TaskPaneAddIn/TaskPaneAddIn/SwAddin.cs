...
{
    /// <summary>
    /// Summary description for TaskPaneAddIn.
    /// </summary>
    ...
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("TaskPaneAddIn.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("TaskPaneAddIn.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("TaskPaneAddIn.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("TaskPaneAddIn.MainIconSmall.bmp", thisAssembly);
